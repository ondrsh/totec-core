 ...
 * terms of the {@code equals} operation, but a {@code com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet} instance
 ...
 *   SortedSet s = Collections.synchronizedSortedSet(new com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet(...));</pre>
 * <p/>
...
public class IndexedTreeSet<E> extends AbstractSet<E>
    ...
    IndexedTreeSet(NavigableMap<E, Object> m) {
        if (!(m instanceof IndexedTreeMap)) {
            throw new IllegalArgumentException("Map should implement com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap");
        }
        this.m = m;
    }
    ...
    @SuppressWarnings("unchecked")
    public int removeGetIndex(Object o) {
        if (this.contains(o)) {
            int index = entryIndex((E) o);
            if (m.remove(o) != PRESENT) System.out.println("error");
            return index;
        }
        else return -1;
    }
    ...
    /**
     * Returns a shallow copy of this {@code com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet} instance. (The elements
    ...
    /**
     * Save the state of the {@code com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet} instance to a stream (that is,
     * serialize it).
     *
    ...
    /**
     * Reconstitute the {@code com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet} instance from a stream (that is,
     * deserialize it).
     */
    @SuppressWarnings("unchecked")
    private void readObject(java.io.ObjectInputStream s)
        ...
        // Create backing com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap
