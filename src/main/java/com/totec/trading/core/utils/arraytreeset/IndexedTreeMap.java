 ...
 *   SortedMap m = Collections.synchronizedSortedMap(new com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap(...));</pre>
 * <p/>
...
//            System.out.println(e.key + ":" + l + ":" + r + ":" + e.weight);
    ...
    public V put(K key, V value) {
        ...
        if (t == null) {
            // TBD:
            // 5045147: (coll) Adding null to an empty com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet should
    ...
    /**
     * Removes the mapping for this key from this com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap if present.
     *
    ...
    /**
     * Returns a shallow copy of this <tt>com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap</tt> instance. (The keys and
    ...
    /**
     * Base class for com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap Iterators
     */
    ...
    /**
     * Compares two keys using the correct comparison method for this com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap.
     */
    @SuppressWarnings("unchecked")
     ...
     * compatibility with previous releases of com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap that did not
    ...
    /**
     * Returns the first Entry in the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap (according to the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap's
     * key-sort function).  Returns null if the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap is empty.
     */
    ...
    /**
     * Returns the last Entry in the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap (according to the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap's
     * key-sort function).  Returns null if the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap is empty.
     */
...
//                    p.parent.updateWeight(delta);
    ...
    /**
     * Save the state of the <tt>com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap</tt> instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <i>size</i> of the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap (the number of key-value
     * mappings) is emitted (int), followed by the key (Object)
     * and value (Object) for each key-value mapping represented
     * by the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap. The key-value mappings are emitted in
     * key-order (as determined by the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap's Comparator,
     * or by the keys' natural ordering if the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap has no
     * Comparator).
     */
    ...
    /**
     * Reconstitute the <tt>com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap</tt> instance from a stream (i.e.,
     * deserialize it).
     */
    ...
    /**
     * Intended to be called only from com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet.readObject
     */
    ...
    /**
     * Intended to be called only from com.totec.trading.commons.utils.arraytreeset.IndexedTreeSet.addAll
     */
     ...
     * <p/>
     * It is assumed that the comparator of the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap is already set prior
     ...
     * It is assumed that the comparator and size fields of the com.totec.trading.commons.utils.arraytreeset.IndexedTreeMap are
